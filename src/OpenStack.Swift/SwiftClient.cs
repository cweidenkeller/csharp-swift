namespace OpenStack.Swift
{
	...
	public class SwiftClient : ISwiftClient
	{
		...
		/// </summary>
		public virtual void DisableSSLCertificateValidation()
		{
	    ...
	    /// </param>
	    public virtual AuthResponse GetAuth(string url, string user, string key, Dictionary<string, string> headers, Dictionary<string, string> query, bool snet)
		{
		...
		/// Full_listing.
		/// </param>
		public virtual AccountResponse GetAccount(string url, string token, Dictionary<string, string> headers, Dictionary<string, string> query, bool full_listing)
		{
		...
		/// Query.
		/// </param>
		public virtual AccountResponse HeadAccount(string url, string token, Dictionary<string, string> headers, Dictionary<string, string> query)
		{
			headers["X-Auth-Token"] = token;
		...
		/// Query.
		/// </param>
		public virtual AccountResponse PostAccount(string url, string token, Dictionary<string, string> headers, Dictionary<string, string> query)
		{
			headers["X-Auth-Token"] = token;
		...
		/// Full_listing.
		/// </param>
		public virtual ContainerResponse GetContainer(string url, string token, string container, Dictionary<string, string> headers, Dictionary<string, string> query, bool full_listing)
		{
			headers["X-Auth-Token"] = token;
			query["format"] = "xml";
		...
		/// </param>
		public virtual ContainerResponse HeadContainer(string url, string token, string container, Dictionary<string, string> headers, Dictionary<string, string> query)
		{
			headers["X-Auth-Token"] = token;
		...
		/// Any custom query strings needed for the request
		/// </param>
		public virtual ContainerResponse PutContainer(string url, string token, string container, Dictionary<string, string> headers, Dictionary<string, string> query)
		{
			headers["X-Auth-Token"] = token;
		...
		/// Any custom query strings needed for the request
		/// </param>
		public virtual ContainerResponse PostContainer(string url, string token, string container, Dictionary<string, string> headers, Dictionary<string, string> query)
		{
			headers["X-Auth-Token"] = token;
		...
		/// Any custom query strings needed for the request
		/// </param>
		public virtual ContainerResponse DeleteContainer(string url, string token, string container, Dictionary<string, string> headers, Dictionary<string, string> query)
		{
			headers["X-Auth-Token"] = token;
		...
		/// Any custom query strings needed for the request
		/// </param>
		public virtual ObjectResponse GetObject(string url, string token, string container, string name, Dictionary<string, string> headers, Dictionary<string, string> query)
		{
            headers["X-Auth-Token"] = token;
		...
		/// Any custom query strings needed for the request
		/// </param>
		public virtual ObjectResponse HeadObject(string url, string token, string container, string name, Dictionary<string, string> headers, Dictionary<string, string> query)
		{
			headers["X-Auth-Token"] = token;
		...
		/// Any custom query strings needed for the request
		/// </param>
		public virtual ObjectResponse PostObject(string url, string token, string container, string name, Dictionary<string, string> headers, Dictionary<string, string> query)
		{
			headers["X-Auth-Token"] = token;
	    ...
	    /// Any custom query strings needed for the request
	    /// </param>
	    public virtual ObjectResponse PutObject(string url, string token, string container, string name, Stream contents, Dictionary<string, string> headers, Dictionary<string, string> query)
		{
			var total_length = 0;
			headers["X-Auth-Token"] = token;
		...
		/// Any custom query strings needed for the request
		/// </param>
		public virtual ObjectResponse DeleteObject(string url, string token, string container, string name, Dictionary<string, string> headers, Dictionary<string, string> query)
		{
			headers["X-Auth-Token"] = token;
